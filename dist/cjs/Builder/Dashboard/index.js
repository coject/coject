...
const Dashboard = ({ menus, logo, icon, search, languages, mobMenus, copyRight, children }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.Box, { className: classes.root },
            react_1.default.createElement(Builder_1.Header, { sidebar: sidebar, setSidebar: setSidebar, menus: menusList, setMenus: setMenusList, logo: logo, icon: icon, search: search, languages: languages, mobMenus: mobMenus }),
