...
const Checkbox = ({ name, label, onChange, trueValue, falseValue, helperText, error, ...props }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.Box, { className: `${classes.root} ${error ? classes.rootError : ""}` },
            react_1.default.createElement(material_1.FormControlLabel, { control: react_1.default.createElement(material_1.Checkbox, { ...(control && register(name || "default")), value: innerValue, checked: checkedValue, onChange: changeValue, ...props }), label: label ? label : (name || "default") }),
