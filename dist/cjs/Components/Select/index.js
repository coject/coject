...
const Select = (_a) => {
    var { name, label, dataSource, customKey, customName, onChange, required, dispatch, inputProps } = _a, props = __rest(_a, ["name", "label", "dataSource", "customKey", "customName", "onChange", "required", "dispatch", "inputProps"]);
    ...
    const MuiAutocomplete = () => {
        return (react_1.default.createElement(material_1.Autocomplete, Object.assign({ id: DropdownID, options: selectData, multiple: props === null || props === void 0 ? void 0 : props.multiple }, props, { value: !!selectData.length && selectedValue
            ...
            }, renderInput: (params) => react_1.default.createElement(material_1.TextField, Object.assign({}, params, inputProps, { label: label ? label : (name || "default"), required: required })) })));
    };
