...
export const Dashboard = ({ menus, logo, icon, search, languages, mobMenus, copyRight, children }) => {
    const { classes } = useStyles();
    const [menusList, setMenusList] = useState(menus);
    const [sidebar, setSidebar] = useState(true);
    return (React.createElement(React.Fragment, null,
        React.createElement(Box, { className: classes.root },
            React.createElement(Header, { sidebar: sidebar, setSidebar: setSidebar, menus: menusList, setMenus: setMenusList, logo: logo, icon: icon, search: search, languages: languages, mobMenus: mobMenus }),
