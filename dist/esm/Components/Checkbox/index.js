...
export const Checkbox = (_a) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Box, { className: classes.root },
            React.createElement(FormControlLabel, { control: React.createElement(MuiCheckbox, Object.assign({}, (control && register(name || "default")), { value: checkedValue, checked: checkedValue, onChange: changeValue }, props)), label: label ? label : name }))));
};
