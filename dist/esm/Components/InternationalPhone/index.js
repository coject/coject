...
export const InternationalPhone = ({ name, label, value, required, fullWidth, disabled, onChange }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(TextField, { disabled: disabled, fullWidth: fullWidth, label: label || "", value: phone, required: !!required, dir: "ltr", helperText: touched && !!required && !phone ? (typeof required === "string" ? required : "This Field Is Required") : "", onBlur: () => setTouched(true), onChange: (e) => setPhone(e.target.value.replace(/\D/g, "")), inputProps: { inputMode: "numeric", dir: "ltr" }, InputProps: {
                startAdornment: (React.createElement(InputAdornment, { position: "start" },
                    React.createElement(Autocomplete, { disableClearable: true, options: countries, value: country, disabled: disabled, onChange: (_, v) => v && setCountry(v), getOptionLabel: (o) => o.code, sx: {
                        ...
                        }, renderInput: (params) => (React.createElement(TextField, { ...params, variant: "standard", InputProps: {
                                ...params.InputProps,
