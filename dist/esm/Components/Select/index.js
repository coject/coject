...
export const Select = ({ name, label, helperText, rules, dataSource, checkboxes, customKey, customName, renderOption, fixedOption, disabledOption, onChange, required, dispatch, inputProps, error, ...props }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Box, { className: classes.root },
            control
                ? React.createElement(Controller, { name: name || "default", control: control, rules: rules, render: () => React.createElement(MuiAutocomplete, null) })
