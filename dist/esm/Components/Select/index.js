...
export const Select = (_a) => {
    ...
    return React.createElement(React.Fragment, null, control ? React.createElement(Controller, { name: name, control: control, rules: { required: required }, render: () => React.createElement(MuiAutocomplete, null) }) : React.createElement(MuiAutocomplete, null));
};
