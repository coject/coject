...
export const Switch = ({ name, onChange, trueValue, falseValue, label, helperText, error, ...props }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Box, { className: `${classes.root} ${error ? classes.rootError : ""}` },
            React.createElement(FormControlLabel, { control: React.createElement(MuiSwitch, { ...(control && register(name || "default")), value: innerValue, checked: checkedValue, onChange: changeValue, ...props }), label: label ? label : (name || "default") }),
