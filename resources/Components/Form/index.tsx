...
// Coject
import { Input, Switch, Select, Checkbox, DatePicker, Upload, Scanner, Email, Phone, InternationalPhone, NationalId, Iban, InputLabel } from "../index";
                            ...
                            {schema && !!schema?.length && schema.map((field: any, index: number) => {
                                if (!(invisibility?.includes(field.field))) switch (field.component?.toLowerCase()) {
                                    ...
                                    case "email":
                                        return field.actionTemplate
                                            ? (<React.Fragment key={index}>{field.actionTemplate(field)}</React.Fragment>)
                                            : (<Grid item key={index} {...(field.componentMedia ? field.componentMedia : { xs: 12, sm: 12, md: 12, lg: 12 })}><Email fullWidth name={field.field} {...field.componentProps} value={Data[field.field] ? Data[field.field] : (Data[field.field] === false ? "false" : field?.componentProps?.value)} /></Grid>);
                                    case "phone":
                                        return field.actionTemplate
                                            ? (<React.Fragment key={index}>{field.actionTemplate(field)}</React.Fragment>)
                                            : (<Grid item key={index} {...(field.componentMedia ? field.componentMedia : { xs: 12, sm: 12, md: 12, lg: 12 })}><Phone fullWidth name={field.field} {...field.componentProps} value={Data[field.field] ? Data[field.field] : (Data[field.field] === false ? "false" : field?.componentProps?.value)} /></Grid>);
                                    case "internationalphone":
                                        return field.actionTemplate
                                            ? (<React.Fragment key={index}>{field.actionTemplate(field)}</React.Fragment>)
                                            : (<Grid item key={index} {...(field.componentMedia ? field.componentMedia : { xs: 12, sm: 12, md: 12, lg: 12 })}><InternationalPhone fullWidth name={field.field} {...field.componentProps} value={Data[field.field] ? Data[field.field] : (Data[field.field] === false ? "false" : field?.componentProps?.value)} /></Grid>);
                                    case "nationalid":
                                        return field.actionTemplate
                                            ? (<React.Fragment key={index}>{field.actionTemplate(field)}</React.Fragment>)
                                            : (<Grid item key={index} {...(field.componentMedia ? field.componentMedia : { xs: 12, sm: 12, md: 12, lg: 12 })}><NationalId fullWidth name={field.field} {...field.componentProps} value={Data[field.field] ? Data[field.field] : (Data[field.field] === false ? "false" : field?.componentProps?.value)} /></Grid>);
                                    case "iban":
                                        return field.actionTemplate
                                            ? (<React.Fragment key={index}>{field.actionTemplate(field)}</React.Fragment>)
                                            : (<Grid item key={index} {...(field.componentMedia ? field.componentMedia : { xs: 12, sm: 12, md: 12, lg: 12 })}><Iban fullWidth name={field.field} {...field.componentProps} value={Data[field.field] ? Data[field.field] : (Data[field.field] === false ? "false" : field?.componentProps?.value)} /></Grid>);
                                    case "switch":
                                        return field.actionTemplate
                                            ? (<React.Fragment key={index}>{field.actionTemplate(field)}</React.Fragment>)
                                    ...
                                    case "scanner":
                                        return field.actionTemplate
                                            ? (<React.Fragment key={index}>{field.actionTemplate(field)}</React.Fragment>)
                                            : (<Grid item key={index} {...(field.componentMedia ? field.componentMedia : { xs: 12, sm: 12, md: 12, lg: 12 })}><Scanner name={field.field} {...field.componentProps} value={Data[field.field] ? Data[field.field] : (Data[field.field] === false ? "false" : field?.componentProps?.value)} /></Grid>);
                                    default:
                                        return null;
                                }
                            })}
